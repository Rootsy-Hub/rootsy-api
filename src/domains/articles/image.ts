...
const ARTICLE_IMAGE_STORAGE_BUCKET = "rootsy_catalog_public"
const MAX_BYTES = 5 * 1024 * 1024

function buildArticleImageFileName(): string {
  return `${crypto.randomUUID()}.webp`
}

function buildArticleImageStoragePath(popId: string, fileName: string): string {
